  ...
  const projects = [
    {
      ...
      description: "Scalable ML infrastructure for model training, deployment, and monitoring. Built with Python and TensorFlow, featuring automated pipeline orchestration, real-time prediction APIs, and comprehensive model versioning with MLflow integration.",
